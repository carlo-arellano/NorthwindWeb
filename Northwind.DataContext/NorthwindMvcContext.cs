...
public partial class NorthwindMvcContext : DbContext
{
    public NorthwindMvcContext()
    {

    }

    public NorthwindMvcContext(DbContextOptions<NorthwindMvcContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            ...
            builder.DataSource = "CARLO-PC\\MSSQL_DEV_2022"; // MS SQL Developer Edition

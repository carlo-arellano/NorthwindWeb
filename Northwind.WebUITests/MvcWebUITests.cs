...
public class MvcWebUITests
{
    ...
    private async Task GotoHomePage(IPlaywright playwright)
    {
        ...
        _response = await _page.GotoAsync("https://localhost:7297/");
    }
    ...
    [Fact]
    public async Task HomePage_Login()
    {
        ...
        await page.GotoAsync("https://localhost:7297/Identity/Account/Login");
        ...
        await page.GetByPlaceholder("password").FillAsync("Pa$$w0rd");
        await page.GetByRole(AriaRole.Button, new()
        {
            Name = "Log in"
        }).ClickAsync();
